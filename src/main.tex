...
\begin{document}
	...
	\(\mathcal{S}(X)\) detones the model space of \(X\), i.e. \(X \in \mathcal{S}(X)\).
	...
	\[ \mathcal{A} \overset{\mathrm{row}}{\in} A = \mathcal{A} \text{ is a row in } A \]
	\[ \mathcal{A} \overset{\mathrm{col}}{\in} A = \mathcal{A} \text{ is a column in } A \]
