...
\begin{document}
	...
	\[ C \overset{\mathrm{col}}{\in} P^{(E)},\quad \bigwedge \limits_{\displaystyle v \in V(\neg C)} \neg \mathrm{bool}(E) \implies V(X) \text{ is an edge non-resolving set} \]

	\[ \bigvee \limits_{\displaystyle C \overset{\mathrm{col}}{\in} P^{(E)}} \left( \bigwedge \limits_{\displaystyle v \in V(\neg C)} \neg \mathrm{bool}(E) \right)\enspace \implies\enspace V(X) \text{ is an edge non-resolving set} \]

	\[ \bigvee \limits_{\displaystyle C \overset{\mathrm{col}}{\in} P^{(E)}} \left( \bigwedge \limits_{\displaystyle v \in V(\neg C)} \neg \mathrm{bool}(E) \right)\enspace \implies\enspace V(\mathcal{S}(X)) \text{ is the edge non-resolving set partition} \]

	\[ \bigwedge \limits_{\displaystyle C \overset{\mathrm{col}}{\in} P^{(E)}} \left( \bigvee \limits_{\displaystyle v \in V(\neg C)} \mathrm{bool}(E) \right)\enspace \implies\enspace V(\mathcal{S}(X)) \text{ is the edge resolving set partition} \]

	\[ \bigwedge \limits_{\displaystyle C \overset{\mathrm{col}}{\in} P^{(E)}} \left( \bigvee \limits_{\displaystyle v \in V(\neg C)} \mathrm{bool}(E) \right)\enspace \implies\enspace V(X) \text{ is an edge resolving set} \]
